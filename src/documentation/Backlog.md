...
- You don't need to delve into JavaFX's technicalities much, most of the GUI is ready
...
- <i class="far fa-exclamation"></i> [Basics of OOP](https://journey.study/v2/learn/materials/pages/oop/basics-of-object-oriented-programming.md)
- <i class="far fa-exclamation"></i> [UML diagrams](https://journey.study/v2/learn/materials/pages/general/uml-unified-modeling-language.md)
- <i class="far fa-exclamation"></i> [How to design classes](https://journey.study/v2/learn/materials/pages/java/how-to-design-classes.md)
